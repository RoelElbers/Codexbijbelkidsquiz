...
vragenData["Romeinen"] = {
    beginner: [
        ...
        },
        {
            ...
            uitleg: "Zegenen betekent niet dat je alles maar goed moet vinden. Een paar regels verder schrijft Paulus dat de overheid er juist is om het kwaad te bestrijden, en hijzelf beriep zich later op zijn recht als Romeins burger toen hem onrecht werd aangedaan.\n\nLiefde en rechtvaardigheid horen bij elkaar: iemand het goede toewensen en tegelijk zeggen dat wat hij doet niet deugt, is geen tegenspraak. Het verschil zit tussen de persoon en zijn gedrag. Wie het gedrag niet durft te benoemen is niet liefdevol, maar onverschillig."
        },
        {
            ...
            uitleg: "Paulus schrijft dit niet zomaar. In de gemeente van Rome zat van alles door elkaar: geboren Joden en mensen uit allerlei andere volken, slaven en vrije mensen, rijk en arm. Ze aten anders, vierden andere feesten en hadden andere gewoonten, en verderop in de brief blijkt dat ze daar flink ruzie over maakten. \"Heb elkaar oprecht lief\" is dus geen mooie zin over mensen die het toch al met elkaar eens waren, maar een opdracht aan mensen die dat juist niet waren.\n\nDat is nog steeds zo: in veel kerken zitten mensen uit heel verschillende landen bij elkaar, en elkaar oprecht liefhebben kost daar soms moeite — precies waar Paulus het over heeft."
        },
        {
...
vragenData["Handelingen"] = {
    ...
    advanced: [
        ...
        },
        {
            ...
            uitleg: "Handen opleggen was een oud gebaar met twee betekenissen: iemand zegenen, en iemand aanwijzen voor een taak. In het Oude Testament legt Mozes zijn handen op Jozua als die zijn opvolger wordt. In de eerste gemeente gebeurde het bij het uitzenden van Paulus en Barnabas, en hier bij de zeven mannen. Het gebaar maakte zichtbaar wat er gebeurde: dit is niet iets wat je jezelf toe-eigent, het wordt je gegeven.\n\nHet gebruik leeft nog steeds. In katholieke kerken hoort handoplegging bij de wijding van een diaken of priester, in protestantse kerken bij de bevestiging van een predikant, ouderling of diaken, en in evangelische gemeenten legt men elkaar vaak de handen op bij het gebed voor iemand die ziek is."
        },
        {
    ...
    expert: [
        ...
        },
        {
            ...
            uitleg: "Agabus hoorde bij een groepje profeten dat vanuit Jeruzalem naar Antiochië kwam. Hij komt twee keer voor in Handelingen, en allebei de keren voorspelt hij iets. Hier de hongersnood, die volgens Lucas kwam toen Claudius keizer was.\n\nDe tweede keer ontmoet hij Paulus in Caesarea: hij pakt Paulus' riem, bindt zichzelf er handen en voeten mee vast en zegt dat het de eigenaar van die riem in Jeruzalem zo zal vergaan. Profeten deden dat vaker — een gebaar dat je niet vergeet, in plaats van alleen woorden."
        },
        {
        ...
        },
        {
            ...
            uitleg: "Twee oude Romeinse wetten verboden het om een burger zonder vonnis te binden of te slaan. Wie dat toch deed, riskeerde zelf een zware straf, en de commandant in dit verhaal schrikt dan ook oprecht — hij had Paulus al laten vastbinden.\n\nHet burgerrecht was niet aan een gebied gebonden: je nam het mee waar je ook kwam, en één zin was genoeg om het in te roepen. Precies dat maakt het ook zo bijzonder dat Paulus die zin niet altijd uitsprak; in Filippi liet hij zich eerst afranselen en zei hij het pas achteraf."
        },
        {
...
vragenData["1 & 2 Korintiërs"] = {
    ...
    advanced: [
        ...
        {
            vraag: "Stel dat iemand alles kan: profeteren, alles begrijpen, zelfs bergen verzetten. Wat is die persoon volgens Paulus als hij geen liefde heeft?",
        ...
        {
            vraag: "Paulus zegt dat ieder de gaven van de Geest op zijn eigen manier merkt. Waar zijn die gaven voor bedoeld?",
