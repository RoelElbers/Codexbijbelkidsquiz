...
const ONTDEK_GELD = [
    ...
    { item: "<span class=\"naslag-term\">Penning</span> — het allerkleinste muntje dat er bestond; mogelijk zelfs het kleinste dat ooit is gemaakt. Eén penning was ongeveer 1/128 van een dagloon, omgerekend zo'n 1 à 1,50 euro van nu. Je had er dus ongeveer 128 nodig voor één dag werken. De arme weduwe gaf er twee — samen zo'n twee à drie euro — en tóch zei Jezus dat zij het meeste had gegeven." },
    { item: "<span class=\"naslag-term\">Denarie</span> — hiermee wordt al het andere vergeleken: het loon voor één hele dag werken, een zilveren muntje van ongeveer 4 gram. Omgerekend dus grofweg 150 à 200 euro van nu." },
    { item: "<span class=\"naslag-term\">Pond</span> — honderd denarie (1/60 van een talent): ongeveer honderd dagen werken, omgerekend zo'n 15.000 à 20.000 euro. Let op: \"pond\" betekent in de Bijbel soms ook een gewicht (ongeveer 300 gram), zoals het pond kostbare olie waarmee Jezus werd gezalfd — dan gaat het dus niet over geld." },
    { item: "<span class=\"naslag-term\">Talent</span> — de allergrootste geldmaat: zesduizend denarie, dus zesduizend daglonen. Daar zou een arbeider zo'n vijftien tot twintig jaar voor moeten werken — omgerekend grofweg tussen de 900.000 en 1,2 miljoen euro. Als gewicht aan zilver of goud was een talent ongeveer 33 kilo (van zo'n 20 tot 40 kilo)." },
];
...
const ONTDEK_PATRONEN = [
    {
        ...
        inhoud: [
            ...
            { item: "Volgens oude kerkelijke overlevering dacht men vroeger dat er precies 153 soorten vissen in de zee bestonden — élke soort die er was. Het beeld werd dan: het net van het evangelie haalt mensen binnen uit élk volk, uit de hele wereld. De blijde boodschap is niet voor één groep, maar voor iedereen." },
