...
// --- Woorden: het woordenboek (47 termen, alfabetisch) ----------------------
const ONTDEK_WOORDENBOEK = [
    ...
    { term: "Opziener", uitleg: "Iemand die toezicht houdt; van het Griekse <em>episkopos</em>. Via het Latijn is daar later ons woord \"bisschop\" uit ontstaan. In de brieven van Paulus gaat het om iemand die leiding gaf aan een plaatselijke gemeente of kerk. Hoe die taak er nu uitziet, verschilt per kerk: een katholieke bisschop geeft leiding aan de kerken in een hele regio, en in veel protestantse kerken houden ouderlingen toezicht op de gemeente. <em>Zie ook: gemeente, kerk.</em>" },
