...
const ONTDEK_GELD = [
    ...
    { item: "<span class=\"naslag-term\">As</span> — € 10 à 12, een zestiende dagloon, ongeveer een half uur werken. Voor één as kocht je twee mussen, en tóch vergeet God er geen enkele van (Matteüs 10:29). In het Grieks heet deze munt assarion." },
    { item: "<span class=\"naslag-term\">Quadrans</span> — € 2 à 3, een vierenzestigste dagloon, ongeveer tien minuten werken (Matteüs 5:26)." },
    { item: "<span class=\"naslag-term\">Penning</span> — € 1 à 2, een honderdachtentwintigste dagloon. Het allerkleinste muntje dat er bestond. De arme weduwe gaf er twee, en Jezus zei dat zij het meeste had gegeven (Marcus 12:42, Lucas 21:2). In het Grieks heet dit muntje lepton." },
